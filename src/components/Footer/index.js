    ...
    <footer className="justify-content-between container flex-row px-1 alli">
      <h2>
        <div data-testid="link" href="/">
          <span id="mail" role="img" aria-label="camera"> </span> kareem.magdy5@gmail.com
        </div>
      </h2>
      <div className="footerKareem flex-row float-right">
        <ul className="flex-row float-right icon">
          ...
          <li>
            <a className="icon" href="https://www.linkedin.com/in/kareem-rizk/" target="_blank"><i className="bi bi-linkedin "></i></a>
          </li>
        </ul>
        </div>
    </footer>
